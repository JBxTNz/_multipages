...
function Todo() {
  ...
  function waitingClick(id) {
    ...
    const todoSelected = todosRaw.find( (todo) => { 
        ...
        // setTodosRaw( todosRaw ) // state ไม่เปลี่ยน
        setTodosRaw( [...todosRaw] ) // state เปลี่ยน 
    ...
    function addClick(id, title) {
        ...
        // setTodosRaw( todosRaw.push(newItem) ) // ไม่ควรใช้
        setTodosRaw( [...todosRaw, newItem] ) // ควรใช้
    }
    ...
    <div className='todo-container'>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Header closeButton>
          <Modal.Title><span className='bi bi-plus-lg'>&nbsp;
            Add todo</span></Modal.Title>
        </Modal.Header>
        ...
        <Modal.Body>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput2">
              ...
              <Form.Control
                type="text"autoFocus ref = {newTitleRef}/>
            </Form.Group>
            </Form>
        </Modal.Body>
